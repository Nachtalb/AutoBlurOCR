...
Function PageReinstall
  ...
  ; upgrading: the previous install stays put and is simply replaced. Same-version runs keep
  ; their Add/Reinstall vs Uninstall choice, and downgrades keep the page and the
  ; ALLOWDOWNGRADES guard untouched.
  ${If} $R0 = 1
    Abort
  ${EndIf}
  ; --- end AutoBlur patch -----------------------------------------------------
